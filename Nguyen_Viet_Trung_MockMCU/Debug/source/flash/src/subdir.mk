...
C_SRCS += \
../source/flash/src/Flash.c 

C_DEPS += \
./source/flash/src/Flash.d 

OBJS += \
./source/flash/src/Flash.o 


# Each subdirectory must supply rules for building sources it contributes
source/flash/src/%.o: ../source/flash/src/%.c source/flash/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-flash-2f-src

clean-source-2f-flash-2f-src:
	-$(RM) ./source/flash/src/Flash.d ./source/flash/src/Flash.o

.PHONY: clean-source-2f-flash-2f-src
