...
C_SRCS += \
../source/boot/src/boot.c 

C_DEPS += \
./source/boot/src/boot.d 

OBJS += \
./source/boot/src/boot.o 


# Each subdirectory must supply rules for building sources it contributes
source/boot/src/%.o: ../source/boot/src/%.c source/boot/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-boot-2f-src

clean-source-2f-boot-2f-src:
	-$(RM) ./source/boot/src/boot.d ./source/boot/src/boot.o

.PHONY: clean-source-2f-boot-2f-src
