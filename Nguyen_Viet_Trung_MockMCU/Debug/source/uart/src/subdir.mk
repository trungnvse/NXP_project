...
C_SRCS += \
../source/uart/src/uart.c 

C_DEPS += \
./source/uart/src/uart.d 

OBJS += \
./source/uart/src/uart.o 


# Each subdirectory must supply rules for building sources it contributes
source/uart/src/%.o: ../source/uart/src/%.c source/uart/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-uart-2f-src

clean-source-2f-uart-2f-src:
	-$(RM) ./source/uart/src/uart.d ./source/uart/src/uart.o

.PHONY: clean-source-2f-uart-2f-src
