...
C_SRCS += \
../source/queue/src/queue.c 

C_DEPS += \
./source/queue/src/queue.d 

OBJS += \
./source/queue/src/queue.o 


# Each subdirectory must supply rules for building sources it contributes
source/queue/src/%.o: ../source/queue/src/%.c source/queue/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-queue-2f-src

clean-source-2f-queue-2f-src:
	-$(RM) ./source/queue/src/queue.d ./source/queue/src/queue.o

.PHONY: clean-source-2f-queue-2f-src
